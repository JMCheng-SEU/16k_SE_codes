...
parser.add_argument('--input_folder', default="F:\\JMCheng\\real_time_exp\\16k_exp_new\\DPRNN_cmp_newwindow_PMSQE_PFPL_APCSNR\\enhancements\\best_checkpoint_35_epoch", type=str)
parser.add_argument('--output_folder', default="F:\\JMCheng\\real_time_exp\\16k_exp_new\\DPRNN_cmp_newwindow_PMSQE_PFPL_APCSNR\\enhancements\\PCS_post_35_epoch", type=str)
