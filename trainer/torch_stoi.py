...
from trainer.kaldi import resample_waveform
...
class Resample(torch.nn.Module):
    ...
    def forward(self, waveform: Tensor) -> Tensor:
        ...
        if self.resampling_method == 'sinc_interpolation':
            ...
            waveform = resample_waveform(waveform, self.orig_freq, self.new_freq)
...
class NegSTOILoss(nn.Module):
    ...
    def __init__(self,
        ...
        self.win = nn.Parameter(win, requires_grad=False).to('cuda')
    ...
    def forward(self, est_targets: torch.Tensor,
        ...
        x_spec = x_spec.to('cuda')
        y_spec = y_spec.to('cuda')
