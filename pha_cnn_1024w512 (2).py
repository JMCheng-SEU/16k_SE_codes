import torch
import numpy as np
from pha_cnn_1024w512 import CRN_for_IRM
import os


model = CRN_for_IRM()
state_dict = torch.load('E:\\SSR\\GRUCNN_params\\model_0007.pth')
...
for i in state_dict:
    ...
    if i.split('.')[1] == '1' or i.split('.')[1] == '0':
        ...
        np.savetxt('E:\\GRUCNN_gln_0930\\{}.txt'.format(name), param)
