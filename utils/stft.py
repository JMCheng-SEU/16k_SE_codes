...
class STFT(torch.nn.Module):
    def __init__(self, filter_length=1024, hop_length=512):
        ...
        filename = 'D:\\JMCheng\\RT_16k\\16k_exp\\window320w512.txt'    ###### D:\\JMCheng\\RT_16k_DNS_exp_new\\window320w512.txt
    ...
    def transform(self, input_data):
        ...
        input_data = F.pad(input_data, (self.hop_length, self.hop_length))
...
if __name__ == '__main__':
    ...
    FFT_model = STFT(filter_length=512, hop_length=320)

    test_inp = torch.randn(1, 16000)

    out = FFT_model(test_inp)

    print(torch.sum((out - test_inp[:, :out.shape[1]]) ** 2))