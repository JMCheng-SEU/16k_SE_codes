...
from trainer.trainer_whole_wav import Trainer
...
def main(config, resume):
    ...
    # scp_file_path = "E:\JMCheng\Microsoft_dataset\DSDATASET\CRN\\train.lst"
...
if __name__ == '__main__':
    # load config file
    config_path = "E:\JMCheng\A-Convolutional-Recurrent-Neural-Network-for-Real-Time-Speech-Enhancement-master\config\\train\\PHA-CRN.json"
